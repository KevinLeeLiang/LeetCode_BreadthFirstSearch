...
/**
  ******************************************************************************
  * @file           : L407_trapRainWater.cpp.cc
  * @author         : garen-lee
  * @brief          : None
  * @attention      : None
  * @date           : 2025/4/30
...
#include "L407_trapRainWater.h"

int L407_trapRainWater::trapRainWater(vector<vector<int>>& heightMap) {
